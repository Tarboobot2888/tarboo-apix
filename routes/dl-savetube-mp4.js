...
// **المسار `/api/download` لتحميل الفيديو**

router.get("/ytmp4", async (req, res) => {

  const { url, type = "video", quality = "360" } = req.query;
...
module.exports = {
    ...
    path: '/api/download/savetube',

    name: 'SAVETUBE-MP4',

    type: 'download',

    url: `${global.t}/api/download/savetube/ytmp4?url=https://youtu.be/-wwUR554Jb8?si=Z9oPDzXyQdmTrgOG`,

    logo: 'https://i.top4top.io/p_3353u2e720.jpg',
